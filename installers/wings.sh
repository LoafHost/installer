...
MYSQL_DBHOST_USER="${MYSQL_DBHOST_USER:-loafpaneluser}"
...
wings_dl() {
  echo "* Downloading Loaf-Wings.. "

  mkdir -p /etc/loaf-panel
  curl -L -o /usr/local/bin/wings "$WINGS_DL_BASE_URL$ARCH"

  chmod u+x /usr/local/bin/wings

  success "Loaf-Wings downloaded successfully"
}
...
perform_install() {
  ...
  success "Loaf-Wings installation is complete!"
}
