...
# Loaf Panel versions
export LOAF_PANEL_VERSION=""
export LOAF_WINGS_VERSION=""
...
# download URLs
export PANEL_DL_URL="https://github.com/LoafHost/panel/releases/latest/download/panel.tar.gz"
export WINGS_DL_BASE_URL="https://github.com/LoafHost/wings/releases/latest/download/wings_linux_"
export MARIADB_URL="https://downloads.mariadb.com/MariaDB/mariadb_repo_setup"
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/LoafHost/installer"}
...
welcome() {
  ...
  print_brake 70
  output "Loaf Panel installation script @ $SCRIPT_RELEASE"
  output ""
  output "Copyright (C) 2018 - 2025, Vilhelm Prytz, <vilhelm@prytznet.se>"
  output "https://github.com/loaf-panel/installer"
  output ""
  output "This script is not associated with the official Loaf Panel Project."
  output ""
  output "Running $OS version $OS_VER."
  if [ "$1" == "panel" ]; then
    output "Latest loaf-panel/panel is $LOAF_PANEL_VERSION"
  elif [ "$1" == "wings" ]; then
    output "Latest loaf-panel/wings is $LOAF_WINGS_VERSION"
  fi
  print_brake 70
}
...
get_latest_versions() {
  ...
  LOAF_PANEL_VERSION=$(get_latest_release "loaf-panel/panel")
  LOAF_WINGS_VERSION=$(get_latest_release "loaf-panel/wings")
}
